...
- Langkah selanjutnya memberikan cara termudah dan direkomendasikan untuk menyiapkan lingkungan Anda untuk menggunakan panda. Pilihan instalasi lainnya dapat ditemukan di halaman instalasi lanjutan. Untuk dapat menginstall pandas, kita bisa menjalankan perintah dengan menggunakan pip ataupun bisa menggunakan Anaconda.
    >`pip install pandas`

- Dengan menggunakan library Anaconda, kita bisa menginstallnya dengan perintah berikut,
    >`Conda install pandas`

- Di JupyterLab, buat buku catatan (Python 3) baru.
